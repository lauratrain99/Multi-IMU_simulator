...
imu1.gyro.bias = ([6; 6; 6]*1e-5)*180/pi; %deg/s
...
imu1.gyro.std = sqrt(imu1.gyro.noisepower*freq*pi/180); %rad/s
...
imu2.gyro.std = sqrt(imu2.gyro.noisepower*freq*pi/180); %rad/s
...
imu3.gyro.std = sqrt(imu3.gyro.noisepower*freq*pi/180); %rad/s
...
imu3.acc.std = sqrt(imu3.acc.noisepower*freq);
...
imu4.gyro.std = sqrt(imu4.gyro.noisepower*freq*pi/180); %rad/s
...
imu4.acc.std = sqrt(imu4.acc.noisepower*freq);
